...
public class ForumComment implements Serializable {
	...
	public String toString() {
		return "评论ID:" + (commentId == null ? "空" : commentId) + "," + 
				...
				"用户ip地址:" + (userIpAddress == null ? "空" : userIpAddress) + "," + 
				"回复人ID:" + (replyUserId == null ? "空" : replyUserId) + "," + 
				"回复人昵称:" + (replyNickName == null ? "空" : replyNickName) + "," + 
				"0:未置顶  1:置顶:" + (topType == null ? "空" : topType) + "," + 
				"发布时间:" + (postTime == null ? "空" : DateUtils.format(postTime, DateTimePatternEnum.YYYY_MM_DD_HH_SS.getPattern())) + "," + 
				"good数量:" + (goodCount == null ? "空" : goodCount) + "," + 
				"0:待审核  1:已审核:" + (status == null ? "空" : status);
	}
}