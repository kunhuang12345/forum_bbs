...
public class UserMessage implements Serializable {
	...
	public String toString() {
		return "自增ID:" + (messageId == null ? "空" : messageId) + "," + 
				"接收人用户ID:" + (receivedUserId == null ? "空" : receivedUserId) + "," + 
				"文章ID:" + (articleId == null ? "空" : articleId) + "," + 
				"文章标题:" + (articleTitle == null ? "空" : articleTitle) + "," + 
				"评论ID:" + (commentId == null ? "空" : commentId) + "," + 
				"发送人用户ID:" + (sendUserId == null ? "空" : sendUserId) + "," + 
				"发送人昵称:" + (sendNickName == null ? "空" : sendNickName) + "," + 
				"0:系统消息 1:评论 2:文章点赞  3:评论点赞 4:附件下载:" + (messageType == null ? "空" : messageType) + "," + 
				"消息内容:" + (messageContent == null ? "空" : messageContent) + "," + 
				"1:未读 2:已读:" + (status == null ? "空" : status) + "," + 
